...
cols.num <- c("totalcorrect", "consecutivecorrect", "reversalnumber", "totalearnings",
              "trial_number", "total_trialnum", "numbercorrectfeedback", "numbercorrectfeedback_block",
              "totalcorrect", "consecutivecorrect", "reversalnumber", "totalearnings", "centsearned", "rt")

reversal[cols.num] <- sapply(reversal[cols.num], as.numeric)
sapply(reversal)
