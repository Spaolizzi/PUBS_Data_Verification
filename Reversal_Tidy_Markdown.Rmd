...
rt_trialnum <- lm(trial_latency ~ total_trialnum, data = reversal)
summary(rt_trialnum)
```
...
Average reaction times averaged approximately 200 ms, which is incredibly short. We should spend some time discussing the implications of this. 
