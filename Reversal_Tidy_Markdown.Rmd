...
reversal_data <- data.table::fread("~/github_repos/ReversalTask/PUBS_Pilot_Sept", fill = TRUE) %>% group_by(subject, time)
...
Reaction times averaged approximately 480 ms, which seems pretty good. There were also 5 trials with 0 latency, which seems physically impossible. 
