...
Next, I;d like to have you go through the whole data frame by eye, and find the names of all the columns that seem to reppresent the demographics variables. At minimum, you should have columns for age, gender identity, and ethnicity, but there may be more columns as well. It might be helpful to use the colnames function to get started. 
...
1. Please add in a vector of the expected values for each of these questionnaires and the demographics. 
...
```{r}
  ...
  #Please create a logical column in summary_df and put the code here
```
